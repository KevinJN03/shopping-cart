...
const App = () =>  {
  const obj1 = { "id": '6bf8c196-c97e-49bc-9de6-fdf3d8454e64', "image1": '/src/assets/product Images/DIORHIGHLIGHT S1I/1.avif', "name": 'DIORHIGHLIGHT S1I', "price": 450, "quantity": 1}
...
setCart(update)
  ...
  <CartContext.Provider value={{cart, allProduct}}>
    {/* <Layout component={<Body addToBasket={addToBasket}/>}></Layout> */}
    <Header/>
    <Body addToBasket= {addToBasket} removeItem={removeItem} updateItem={updateItem}/>
    <Footer/>
